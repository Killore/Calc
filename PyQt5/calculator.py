...
class Calculator(QWidget):
    ...
    def initUI(self):
        self.setGeometry(300, 300, 225, 430)
        ...
        self.tsdel = QPushButton('//', self)
        self.tsdel.resize(50, 50)
        self.tsdel.move(60, 375)

        self.vvsqrt = QPushButton('^2', self)
        self.vvsqrt.resize(50, 50)
        self.vvsqrt.move(115, 375)
        ...
        self.tsdel.clicked.connect(self.tsdel_1)
        self.vvsqrt.clicked.connect(self.vvsqrt_1)
